...
urlpatterns = [
    ...
    path('bookings/update/<int:booking_id>/', views.BookingUpdate.as_view(), name="update-booking"), 
    path('bookings/delete/<int:booking_id>/', views.BookingDelete.as_view(), name="cancel-booking"), 
]
